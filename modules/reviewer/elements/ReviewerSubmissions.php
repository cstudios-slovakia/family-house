...
namespace modules\reviewermodule\elements;
...
use modules\reviewermodule\elements\db\ReviewerSubmissionsQuery;
 ...
 * @since     1.0.0
 */
class ReviewerSubmissions extends Element
{
    // Public Properties
    // =========================================================================
...
//    public $email;
    ...
    {
        return new ReviewerSubmissionsQuery(static::class);
    }
    ...
    {
        return UrlHelper::cpUrl('reviewer/person/'.$this->id);
    }
...
//        Craft::dd(self::find()->all());
//        $forms = array_unique(array_map(function (ReviewerSubmissions $submission) {
//            return $submission->form;
//        }, self::find()->all()));
        $sources = [
            [
                'key'      => '*',
                'label'    => Craft::t('reviewer', 'All submissions'),
                'criteria' => [],
            ],
        ];
        return $sources;
    ...
    {
        $attributes = [
            'id'          => Craft::t('reviewer', 'ID'),
            'first_name'        => Craft::t('reviewer', 'First name'),
            'last_name'     => Craft::t('reviewer', 'Last name'),
            'email'    => Craft::t('reviewer', 'email'),
            'dateCreated'   => Craft::t('reviewer', 'Created at'),
