...
namespace modules\preparatormodule\fields;

use modules\preparatormodule\PreparatorModule;
use modules\preparatormodule\assetbundles\readerfield\ReaderFieldAsset;
...
class Reader extends Field
{
    ...
    {
        return Craft::t('preparator-module', 'Reader');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'preparator-module/_components/fields/Reader_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(ReaderFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').PreparatorModuleReader(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'preparator-module/_components/fields/Reader_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
