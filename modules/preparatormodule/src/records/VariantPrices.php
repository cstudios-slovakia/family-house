 ...
 * @since     1.0.0
 */
class VariantPrices extends ActiveRecord
{
    ...
    {
        return '{{%preparatormodule_variant_prices}}';
    }

    public function rules()
    {
        return [
            [['price', 'variant_id', 'price_index'], 'required'],
            [['price'], 'number','min' => 0],
            [['price', 'variant_id', 'price_index'], 'safe'],
            [['price_index'], 'integer','min' => 0],
        ];
    }
}
