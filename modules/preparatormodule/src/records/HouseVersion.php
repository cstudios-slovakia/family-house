 ...
 * @since     1.0.0
 */
class HouseVersion extends ActiveRecord
{
    ...
    {
        return '{{%preparatormodule_houseversions}}';
    }

    public function rules()
    {
        return [
            [['possibility', 'version_number', 'price'], 'required'],
            [['price'], 'number','min' => 0],
            [['possibility', 'version_number', 'price'], 'safe'],
