 ...
 * @since     1.0.0
 */
class EnergyPrices extends ActiveRecord
{
    ...
    {
        return '{{%preparatormodule_energy_prices}}';
    }

    public function rules()
    {
        return [
            [['price', 'energy_id', 'energy_price_index'], 'required'],
            [['price'], 'number','min' => 0],
            [['price', 'energy_id', 'energy_price_index'], 'safe'],
            [['energy_price_index','energy_id'], 'integer','min' => 0],
        ];
    }
}
