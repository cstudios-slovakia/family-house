 ...
 * @since     1.0.0
 */
let appModule = $('#app.preparator--module');
if (appModule.length > 0) {

    let app = new Vue({
        el: '#app.preparator--module',
        delimiters: ['{','}'],
        data: {
...
console.log('type key', typeKey);
            ...
            request() {
                ...
                return axios({
                    ...
                    url: typeof window.currentSiteBaseUrl === 'undefined' ? 'https://familyhouse.sk' : window.currentSiteBaseUrl + '/admin/preparator/reader/calculate',
                    method: 'POST',
